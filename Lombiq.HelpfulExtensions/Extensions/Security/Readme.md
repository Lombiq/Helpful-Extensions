...
This is how you can make a content type use strict security in migrations:
...
You can also enable it by going to the content type editor on the admin site and checking the _Strict Securable_ checkbox.
